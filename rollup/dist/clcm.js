(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.clcm = {}, global.React));
	...
	var Clcm = function Clcm(props) {
	  var code = props.code;
	  var msg = null;
	  var result = '';
	  var diffRef = /*#__PURE__*/React__default["default"].createRef();

	  var initUI = function initUI(code) {
	    diffRef.current.focus();
	    var node = diffRef.current;
	    node.innerHTML = "";
	    var target = codemirror.MergeView(node, {
	      extraKeys: {
	        Ctrl: 'autocomplete'
	      },
	  ...
	  var handleEdit = function handleEdit(code) {
	    var msg = code ? JSON.parse(JSON.stringify(code)) : '{}';
	    initUI(msg);
	  };
	  ...
	  return /*#__PURE__*/React__default["default"].createElement("div", null, /*#__PURE__*/React__default["default"].createElement("div", {
	    ...
	    onClick: function onClick() {
	      return handleEdit(code);
	    }
	  }, /*#__PURE__*/React__default["default"].createElement("span", null, "\u5C55\u793A")), /*#__PURE__*/React__default["default"].createElement("div", {
	    id: "diff_view",
	    ref: diffRef
	  ...
	  }, /*#__PURE__*/React__default["default"].createElement("span", null, "\u590D\u5236")));
	};

	exports["default"] = Clcm;

	Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=clcm.js.map
